namespace PayRoll_Client.View
{
    partial class JoinProjectTake
    {
        ...
        private void InitializeComponent()
        {
            ...
            // nextPageBtn
            // 
            nextPageBtn.Location = new Point(465, 3);
            ...
            prePageBtn.Location = new Point(153, 3);
            prePageBtn.Name = "prePageBtn";
            prePageBtn.Size = new Size(75, 23);
            prePageBtn.TabIndex = 0;
            prePageBtn.Text = " ◀ ";
            ...
            pageLab.Location = new Point(234, 0);
            pageLab.Name = "pageLab";
            pageLab.Size = new Size(225, 48);
            pageLab.TabIndex = 2;
            pageLab.Text = "label1";
            // 
            // OKBtn
            // 
            OKBtn.Location = new Point(696, 3);
            OKBtn.Name = "OKBtn";
            ...
            // cancelBtn
            // 
            cancelBtn.Location = new Point(796, 3);
            ...
            // pageBodyLyout
            // 
            pageBodyLyout.ColumnCount = 2;
            pageBodyLyout.ColumnStyles.Add(new ColumnStyle(SizeType.Percent, 76.92308F));
            pageBodyLyout.ColumnStyles.Add(new ColumnStyle(SizeType.Percent, 23.0769234F));
